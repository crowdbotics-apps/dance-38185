"""
Django settings for dance_38185 project.
...
WSGI_APPLICATION = 'dance_38185.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "dance_38185 API",
    "DESCRIPTION": "API documentation for dance_38185 App",
    "VERSION": "v1",
}
